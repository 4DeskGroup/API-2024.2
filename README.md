...
| 8    | Média      | Refinamento da interface front-end<br>Como um usuário final, quero visualizar uma interface de fácil e intuitiva navegação para que eu tenha uma experiência agradável.                                                                                                                            |      20      |   3     |          RF2            |
