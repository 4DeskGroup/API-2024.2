...
| 6    | Média      | Classificação de Produtos<br>Como um funcionário do departamento de compras, eu quero ver uma classificação clara dos produtos (muito bom, bom, neutro, ruim), para que eu possa priorizar os melhores produtos. |      21      | 3      | RF1 - RF2                   |
