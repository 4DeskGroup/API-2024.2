...
| 7    | Média      | Refinamento da interface (front-end)<br>Como um usuário final, quero visualizar uma interface de fácil navegação para que eu tenha uma experiência agradável.                                                                                                                            |      2      |   20     |          RF2            |
| 8    | Baixa      | Tutorial em Vídeo<br>Como um usuário final não técnico, eu quero acessar um vídeo tutorial, para que eu possa entender como usar a plataforma de maneira eficiente. |      2      | 3      | RNF1                  |
</br>
